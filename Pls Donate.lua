...
if queueonteleport then
  queueonteleport("loadstring(game:HttpGet('https://raw.githubusercontent.com/F2B-HUB/C84FO/main/Pls%20Donate.lua'))()")
end
...
local function a(a)game:GetService("VirtualInputManager"):SendMouseButtonEvent(a.AbsolutePosition.X+a.AbsoluteSize.X/2,a.AbsolutePosition.Y+50,0,true,a,1)game:GetService("VirtualInputManager"):SendMouseButtonEvent(a.AbsolutePosition.X+a.AbsoluteSize.X/2,a.AbsolutePosition.Y+50,0,false,a,1)end;a(game:GetService("Players").LocalPlayer.PlayerGui.PromptWearLastOutfit.Frame.Options.Yes)
                end 
            end
		end
	end)
